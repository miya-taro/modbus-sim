...
A desktop app that simulates **Modbus TCP and RTU slaves simultaneously**, for developing/testing Modbus masters. TCP and RTU slave data are fully isolated even when Slave IDs collide.
